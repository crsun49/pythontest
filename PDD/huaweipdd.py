...
while True:
    ...
    if elem.exists or iSign==1:
        ...
        if len(split_string) > 1:
            ...
            print("未找到斜杠后面的数字")
        time.sleep(1)
        #d(resourceId="com.xunmeng.pinduoduo:id/pdd", text="6.9")
        #点击商品第一张图片
        d.click(0.498, 0.242)
        time.sleep(1)
        #长按图片
        ...
        #切换到记事本获取商品地址
        d.app_stop("com.huawei.notepad")
        d.app_start("com.huawei.notepad")
        time.sleep(3)
        d.click(0.848, 0.9)
